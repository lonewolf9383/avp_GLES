...
typedef void (GL_APIENTRY *PFNGLLOADMATRIXF) (const GLfloat *m);
typedef void (GL_APIENTRY *PFNGLPIXELSTOREI) (GLenum pname, GLint param);
typedef void (GL_APIENTRY *PFNGLPOINTSIZE)(GLfloat size);
...
extern PFNGLLOADMATRIXF pglLoadMatrixf;
...
extern PFNGLPOINTSIZE pglPointSize;
...
typedef void (APIENTRY *PFNGLLOADMATRIXF) (GLfloat *val);
