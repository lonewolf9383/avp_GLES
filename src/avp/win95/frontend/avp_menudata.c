...
char MP_SessionName[MAX_PLAYER_NAME_LENGTH+23] = "TEST SESH";
char IPAddressString[MAX_IPADDRESS_LENGTH+1]= ""; 
unsigned int g_netPortAddress = 26000;
...
//	{AVPMENU_ELEMENT_GOTOMENU, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER,	AVPMENU_SINGLEPLAYER},
	{AVPMENU_ELEMENT_GOTOMENU, TEXTSTRING_MAINMENU_MULTIPLAYER,			AVPMENU_MULTIPLAYEROPENADDRESS},
	{AVPMENU_ELEMENT_GOTOMENU, TEXTSTRING_MAINMENU_GAMEPLAYOPTIONS,		AVPMENU_OPTIONS},
	{AVPMENU_ELEMENT_GOTOMENU, TEXTSTRING_AVOPTIONS_TITLE,				AVPMENU_MAINMENUAVOPTIONS},
	{AVPMENU_ELEMENT_QUITGAME, TEXTSTRING_MAINMENU_EXITGAME,			0},
	{AVPMENU_ELEMENT_ENDOFMENU}
...
#endif
	{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_MAINMENU_MULTIPLAYER},		{AVPMENU_MULTIPLAYER},{0},{0},TEXTSTRING_MAINMENU_MULTIPLAYER_HELP},
...
static AVPMENU_ELEMENT AvPMenu_JoystickControlsOptions[] =
{
	...
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_JOYSTICKCONTROLS_AXIS2_VERTICAL},{1}, 	{(int*)&PlayerJoystickControlMethods.JoystickAxis2IsMovement},	{TEXTSTRING_MOUSECONTROLS_LOOKING},	  TEXTSTRING_JOYSTICKCONTROLS_AXIS2_VERTICAL_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_JOYSTICKCONTROLS_AXIS2_HORIZONTAL},{1},	{(int*)&PlayerJoystickControlMethods.JoystickAxis2IsTurning},	{TEXTSTRING_MOUSECONTROLS_SIDESTEPPING}, TEXTSTRING_JOYSTICKCONTROLS_AXIS2_HORIZONTAL_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	{TEXTSTRING_JOYSTICKCONTROLS_AXIS2_REVERSED},  {1}, 	{(int*)&PlayerJoystickControlMethods.JoystickAxis2FlipVerticalAxis},{TEXTSTRING_NO},						  TEXTSTRING_JOYSTICKCONTROLS_AXIS2_REVERSED_HELP},

	{AVPMENU_ELEMENT_SLIDER,	{TEXTSTRING_JOYSTICKCONTROLS_AXIS2_HORIZONTAL_SENSITIVITY},	JOYSTICK_SENSITIVITY_MAX, 	{(int*)&PlayerJoystickControlMethods.JoystickAxis2HorizontalSensitivity},		{0},	TEXTSTRING_JOYSTICKCONTROLS_AXIS2_HORIZONTAL_SENSITIVITY_HELP},
	{AVPMENU_ELEMENT_SLIDER,	{TEXTSTRING_JOYSTICKCONTROLS_AXIS2_VERTICAL_SENSITIVITY},	JOYSTICK_SENSITIVITY_MAX, 	{(int*)&PlayerJoystickControlMethods.JoystickAxis2VerticalSensitivity},		{0}, 	TEXTSTRING_JOYSTICKCONTROLS_AXIS2_VERTICAL_SENSITIVITY_HELP},
...
static AVPMENU_ELEMENT AvPMenu_Multiplayer[]=
{
	...
	{AVPMENU_ELEMENT_GOTOMENU, 	{TEXTSTRING_MULTIPLAYER_JOINGAME},	{AVPMENU_MULTIPLAYEROPENADDRESS},	{0},	{0},	TEXTSTRING_MULTIPLAYER_OPENADDRESS_HELP},
...
{
	{AVPMENU_ELEMENT_TEXTFIELD, 	{TEXTSTRING_MULTIPLAYER_SESSIONNAME},	{MAX_PLAYER_NAME_LENGTH},	{(int*)MP_SessionName}},
...
static AVPMENU_ELEMENT AvPMenu_MultiplayerBeginConnection[]=
{
	{AVPMENU_ELEMENT_DUMMYTEXTFIELD, 	{TEXTSTRING_MULTIPLAYER_CONNECTING_TITLE},	{MAX_IPADDRESS_LENGTH + 1},	{(int*)IPAddressString},	{TEXTSTRING_BLANK},	{TEXTSTRING_BLANK}},
	{AVPMENU_ELEMENT_ENDOFMENU}
};

static AVPMENU_ELEMENT AvPMenu_MultiplayerConnectFailed[]=
{
	{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_OK}, {AVPMENU_MULTIPLAYEROPENADDRESS}, {0}, {0}, {TEXTSTRING_BLANK}},
	{AVPMENU_ELEMENT_ENDOFMENU}
};

static AVPMENU_ELEMENT AvPMenu_MultiplayerHostFailed[]=
{
	{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_OK}, {AVPMENU_MULTIPLAYER_CONFIG}, {0}, {0}, {TEXTSTRING_BLANK}},
	{AVPMENU_ELEMENT_ENDOFMENU}
};

static AVPMENU_ELEMENT AvPMenu_MultiplayerConnectionLost[]=
{
	{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_OK}, {AVPMENU_MULTIPLAYEROPENADDRESS}, {0}, {0}, {TEXTSTRING_BLANK}},
	{AVPMENU_ELEMENT_ENDOFMENU}
};

static AVPMENU_ELEMENT AvPMenu_MultiplayerHostFull[]=
{
	{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_OK}, {AVPMENU_MULTIPLAYEROPENADDRESS}, {0}, {0}, {TEXTSTRING_BLANK}},
	{AVPMENU_ELEMENT_ENDOFMENU}
};
...
{
	//{AVPMENU_ELEMENT_DUMMYTEXTFIELD, 	{TEXTSTRING_MULTIPLAYER_SESSIONNAME},	{MAX_PLAYER_NAME_LENGTH},		{(int*)MP_SessionName}},
	{AVPMENU_ELEMENT_TEXTSLIDER,		{TEXTSTRING_MULTIPLAYER_SPECIES},		{2},									{&MP_Species},		{TEXTSTRING_MULTIPLAYER_MARINE}},
...
static AVPMENU_ELEMENT AvPMenu_MultiplayerOpenAddress[]=
{
	...
	{AVPMENU_ELEMENT_NUMBERFIELD,	{TEXTSTRING_MULTIPLAYER_PORT},	{65535},	{&g_netPortAddress},	{TEXTSTRING_BLANK},	TEXTSTRING_BLANK,	TEXTSTRING_BLANK},
	{AVPMENU_ELEMENT_TEXTFIELD, {TEXTSTRING_FILENAME}, {20},	{(int*)IP_Address_Name},	{0},	TEXTSTRING_MPHELP_ADDRESSDESCRIPTION},
	{AVPMENU_ELEMENT_GOTOMENU,	{TEXTSTRING_MULTIPLAYER_OKTOCONNECT},	{AVPMENU_MULTIPLAYER_BEGINCONNECTION},	{0},	{0},	TEXTSTRING_MULTIPLAYER_OKTOCONNECT_HELP},
...
AVPMENU_ELEMENT AvPMenu_Multiplayer_Config[]=
{
	...
	{AVPMENU_ELEMENT_TEXTFIELD, 	{TEXTSTRING_MULTIPLAYER_SESSIONNAME},	{MAX_PLAYER_NAME_LENGTH},	{(int*)MP_SessionName},	{TEXTSTRING_BLANK},	TEXTSTRING_MPHELP_SESSIONNAME},
...
AVPMENU_ELEMENT AvPMenu_Multiplayer_Config_Join[]=
{
	...
	{AVPMENU_ELEMENT_DUMMYTEXTFIELD, 	{TEXTSTRING_MULTIPLAYER_SESSIONNAME},	{MAX_PLAYER_NAME_LENGTH},	{(int*)MP_SessionName},	{TEXTSTRING_BLANK},	TEXTSTRING_MPHELP_SESSIONNAME},
...
static AVPMENU_ELEMENT AvPMenu_InGame[] =
{
	...
	{AVPMENU_ELEMENT_QUIT_INGAME, {TEXTSTRING_INGAMEMENU_QUITTOMAINMENU},			{0}},
	{AVPMENU_ELEMENT_ENDOFMENU}
};
...
AVPMENU AvPMenusData[]= 
{
	...
	// AVPMENU_MULTIPLAYER_BEGINCONNECTION
	{AVPMENU_FONT_BIG, TEXTSTRING_MULTIPLAYER_CONNECTING_TITLE,		AvPMenu_MultiplayerBeginConnection, AVPMENU_MULTIPLAYER_CONFIG_JOIN, 0},

	// AVPMENU_MULTIPLAYER_CONNECTFAILED
	{AVPMENU_FONT_BIG, TEXTSTRING_MULTIPLAYER_CONNECT_FAILED, AvPMenu_MultiplayerConnectFailed, AVPMENU_MULTIPLAYEROPENADDRESS, 0},

	// AVPMENU_MULTIPLAYER_HOSTFAILED
	{AVPMENU_FONT_BIG, TEXTSTRING_MULTIPLAYER_HOST_FAILED, AvPMenu_MultiplayerHostFailed, AVPMENU_MULTIPLAYER_CONFIG, 0},

	// AVPMENU_MULTIPLAYER_CONNECTIONLOST
	{AVPMENU_FONT_BIG, TEXTSTRING_MULTIPLAYER_CONNECTION_LOST, AvPMenu_MultiplayerConnectionLost, AVPMENU_MULTIPLAYEROPENADDRESS, 0},

	// AVPMENU_MULTIPLAYER_HOSTFULL
	{AVPMENU_FONT_BIG, TEXTSTRING_MULTIPLAYER_HOSTFULL, AvPMenu_MultiplayerHostFull, AVPMENU_MULTIPLAYEROPENADDRESS, 0},

	// AVPMENU_MULTIPLAYERJOINGAME2
	{AVPMENU_FONT_BIG,	TEXTSTRING_MULTIPLAYER_JOINGAME,		AvPMenu_MultiplayerJoinGame2,		AVPMENU_MULTIPLAYER,	0},

	// AVPMENU_MULTIPLAYEROPENADDRESS
	{AVPMENU_FONT_BIG,	TEXTSTRING_MULTIPLAYER_OPENADDRESS,		AvPMenu_MultiplayerOpenAddress,	AVPMENU_MULTIPLAYER,	0},
