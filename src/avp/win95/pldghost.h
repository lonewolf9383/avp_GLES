...
//extern void RemovePlayersGhosts(NetworkID id);
//extern void RemovePlayerGhost(NetworkID id);
//extern STRATEGYBLOCK *FindGhost(NetworkID Id, int obId);
//extern STRATEGYBLOCK *CreateNetGhost(NetworkID playerId, int objectId, VECTORCH *position, EULER* orientation, AVP_BEHAVIOUR_TYPE type, unsigned char IOType, unsigned char subtype);
extern void RemovePlayersGhosts(NetworkID id);
extern void RemovePlayerGhost(NetworkID id);
extern STRATEGYBLOCK *FindGhost(NetworkID Id, int obId);
extern STRATEGYBLOCK *CreateNetGhost(NetworkID playerId, int objectId, VECTORCH *position, EULER* orientation, AVP_BEHAVIOUR_TYPE type, unsigned char IOType, unsigned char subtype);
