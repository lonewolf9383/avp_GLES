...
void Preprocess_Section(SECTION *this_section, char *riffname ,VECTORCH* offset_to_return) {
	...
	//this_section->gore_spray_direction.vx = cumulative_gore_direction.vx;
	//this_section->gore_spray_direction.vy = cumulative_gore_direction.vy;
	//this_section->gore_spray_direction.vz = cumulative_gore_direction.vz;
